...
//  VKNewsFeed
//
//  Created by Анастасия Кудашева on 07.10.2020.
...
final class NewsfeedCodeCell: UITableViewCell {
    ...
    let postlabel: UITextView = {
        ...
        textView.textColor = #colorLiteral(red: 0.0001590510899, green: 0.02314645317, blue: 0.0972596764, alpha: 1)
    ...
    var galaryCollectionView: GalleryCollectionView = {
    ...
    // MARK: - forth layout - for bottomView
    // for likesView
    ...
    let commentsImage: UIImageView = {
        let imageView = UIImageView()
        imageView.translatesAutoresizingMaskIntoConstraints = false
        imageView.image = UIImage(named: "comment.png")
        return imageView
    }()
    ...
    let sharesImage: UIImageView = {
        let imageView = UIImageView()
        imageView.translatesAutoresizingMaskIntoConstraints = false
        imageView.image = UIImage(named: "share.png")
        return imageView
    }()
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        // MARK: - This func is not available in iOS14
        moreTextButton.addTarget(self, action: #selector(moreTextButtonToched), for: .touchUpInside)
    ...
    // MARK: - This func is not available in iOS14
    @objc func moreTextButtonToched()  {
    ...
    func set(viewModel: FeedCellViewModel) {
        ...
        if let photoAttachment = viewModel.photoAttachements.first, viewModel.photoAttachements.count == 1 {
            ...
            galaryCollectionView.set(photos: viewModel.photoAttachements)
            postImageView.isHidden = true
            galaryCollectionView.isHidden = false
            galaryCollectionView.frame = viewModel.sizes.attachmentFrame
